    ...
    <header>
      <div className="container">
        <AnchorLink href="#about" className="links">
          <span className="header-span">&lt;</span>Daniel<span style={{ color: 'rgb(133, 76, 230)' }}>/</span>Beling<span className="header-span">&gt;</span>
        </AnchorLink>
        ...
        <div className={classOn ? 'menu-section on' : 'menu-section'} onClick={() => setClassOn(!classOn)}>
          ...
          <nav>
            <ul>
              ...
              <li>
                <AnchorLink href="#experience">Experiencia</AnchorLink>
              </li>
              <li>
                <AnchorLink href="#projects">Projetos</AnchorLink>
              </li>
              <li>
                <AnchorLink href="#education">Educação</AnchorLink>
              </li>
              <li>
